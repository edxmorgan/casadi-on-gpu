...
This project shows how to take CasADi-generated C code, patch it for CUDA, and evaluate functions directly on the GPU. The demo below evaluates **80k** batch of forward kinematics for a 4 dof robot arm in under **three milliseconds**. 
<p align="center">
